...
export function DeleteUserModal({ isOpen, onClose, onConfirm, loading, userName }: DeleteUserModalProps) {
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.message}>
            Você tem certeza que deseja excluir o usuário <Text style={styles.bold}>{userName}</Text>? 
